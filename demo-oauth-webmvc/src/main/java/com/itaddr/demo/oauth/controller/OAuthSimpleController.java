package com.itaddr.demo.oauth.controller;

import com.itaddr.demo.oauth.config.OAuthWebmvcProperties;
...
public class OAuthSimpleController {

    private final OAuthWebmvcProperties prop;

    private final Map<String, UserVO> userMap;

    public OAuthSimpleController(OAuthWebmvcProperties prop, @Qualifier("userMap") Map<String, UserVO> userMap) {
        this.prop = prop;
